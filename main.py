...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text="Advanced Tic Tac Toe Game", bd=21, bg='Cadet blue', fg='Coral',
                 justify=CENTER)
...
LeftFrame = Frame(MainFrame, bd=10, width=750, height=500, pady=1, padx=10, bg="Cadet blue", relief=RIDGE)
...
def scorekeeper():
    if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X"):
        ...
        score = (n + 1)
        PlayerX.set(score)
        tkinter.messagebox.showinfo("Winner X", "You just won a game")
    ...
    if (button1["text"] == "O" and button2["text"] == "O" and button3["text"] == "O"):
        ...
        score = (n + 1)
        PlayerO.set(score)
        tkinter.messagebox.showinfo("Winner O", "You just won a game")
...
btnReset = Button(RightFrame2, text="Reset ", font='Times 26 bold', height=2, width=33, bg="gainsboro", command=reset)
btnReset.grid(row=0, column=0, padx=6, pady=11)

btnNewGame = Button(RightFrame2, text="New Game", font='Times 26 bold', height=2, width=33, bg="gainsboro",
                    command=NewGame)
btnNewGame.grid(row=1, column=0, padx=6, pady=10)

button1 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button1))
button1.grid(row=1, column=0, sticky=S + N + E + W)

button2 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button2))
button2.grid(row=1, column=1, sticky=S + N + E + W)

button3 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button3))
button3.grid(row=1, column=2, sticky=S + N + E + W)

button4 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button4))
button4.grid(row=2, column=0, sticky=S + N + E + W)

button5 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button5))
button5.grid(row=2, column=1, sticky=S + N + E + W)

button6 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button6))
button6.grid(row=2, column=2, sticky=S + N + E + W)

button7 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button7))
button7.grid(row=3, column=0, sticky=S + N + E + W)

button8 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
                 command=lambda: checker(button8))
button8.grid(row=3, column=1, sticky=S + N + E + W)

button9 = Button(LeftFrame, text=" ", font='Times 26 bold', height=2, width=6, bg="gainsboro",
